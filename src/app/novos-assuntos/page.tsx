...
import { FaLaptop, FaNetworkWired, FaRobot, FaAppStore, FaMicrochip } from "react-icons/fa";

const newTopics = [
    {
        name: "Computador",
        slug: "computer",
        icon: <FaLaptop className="text-white w-8 h-8" />,
        color: "bg-blue-500"
    },
    {
        name: "Internet",
        slug: "internet",
        icon: <FaNetworkWired className="text-white w-8 h-8" />,
        color: "bg-purple-500"
    },
    {
        name: "Aplicações",
        slug: "aplicacoes",
        icon: <FaAppStore className="text-white w-8 h-8" />,
        color: "bg-yellow-500"
    },
    {
        name: "Redes",
    ...
    },
    {
        ...
        icon: <FaMicrochip className="text-white w-8 h-8" />,
